...
{
    public class ITMTransportLineStatusesManager : SingletonLite<ITMTransportLineStatusesManager>
    {
        ...
        public ITMTransportLineStatusesManager()
        {
        ...
        public static void UpdateData(SimulationManager.UpdateMode mode)
        {
            ...
            {
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_linesDataLong);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_vehiclesDataLong);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_stopDataLong);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_linesDataInt);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_vehiclesDataInt);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_stopDataInt);
                ClearArray(ref SingletonLite<ITMTransportLineStatusesManager>.instance.m_linesDataUshort);
            }
        ...
        internal enum LineDataSmallInt
        {
            TOTAL_PASSENGERS,
            TOURIST_PASSENGERS,
            STUDENT_PASSENGERS
